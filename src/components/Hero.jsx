          ...
          <div className="flex flex-col justify-center lg:pr-6">
            ...
            >
              ...
              >
                ...
                {/* Tooltip */}
                <span className="absolute -top-7 left-1/2 -translate-x-1/2 px-2 py-0.5 rounded text-[0.6rem] font-mono tracking-wide bg-[#9D8DF1] text-[#1A1A1A] opacity-0 group-hover:opacity-100 transition-opacity duration-200 whitespace-nowrap pointer-events-none">
                  Download CV
                </span>
              </a>
